...
public class Maquina {
  ...
  //Lista de operadores
	...
	public void setStatus(String status) {
		if (status.equals("Em Processo") || status.equals("Parada") || status.equals("Em Manutencao") || status.equals("em processo") || status.equals("parada") || status.equals("em manutencao") || status.equals("EM PROCESSO") || status.equals("PARADA") || status.equals("EM MANUTENCAO"))
			this.status = status;
		else 
